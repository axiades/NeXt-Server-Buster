...
sed -i 's/HPKP1="1"/HPKP1="'${HPKP1}'"/' /root/Perfectrootserver/configs/userconfig.cfg
sed -i 's/HPKP2="2"/HPKP2="'${HPKP2}'"/' /root/Perfectrootserver/configs/userconfig.cfg
...
#delete old keys
sed -i 's/HPKP1="'${HPKP1}'"/HPKP1="1"/' /root/Perfectrootserver/configs/userconfig.cfg
sed -i 's/HPKP2="'${HPKP2}'"/HPKP2="2"/' /root/Perfectrootserver/configs/userconfig.cfg
