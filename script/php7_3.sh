...
cp /root/NeXt-Server-Buster/configs/php/php.ini /etc/php/$PHPVERSION7/fpm/php.ini
cp /root/NeXt-Server-Buster/configs/php/php-fpm.conf /etc/php/$PHPVERSION7/fpm/php-fpm.conf
cp /root/NeXt-Server-Buster/configs/php/www.conf /etc/php/$PHPVERSION7/fpm/pool.d/www.conf
