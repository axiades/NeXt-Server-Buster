...
cd /root/Perfectrootserver/sources
...
--with-openssl=/root/Perfectrootserver/sources/openssl-${OPENSSL_VERSION} \
--add-module=/root/Perfectrootserver/sources/naxsi/naxsi_src \
--add-module=/root/Perfectrootserver/sources/incubator-pagespeed-ngx-${NPS_VERSION} \
--add-module=/root/Perfectrootserver/sources/headers-more-nginx-module-${NGINX_HEADER_MOD_VERSION}"
...
rm -R /root/Perfectrootserver/sources/nginx-${NGINX_VERSION}
...
cp /root/Perfectrootserver/configs/nginx/confs/* /etc/nginx/

rm -rf /etc/nginx/sites-available/${MYDOMAIN}.conf
cp /root/Perfectrootserver/configs/nginx/vhost /etc/nginx/sites-available/${MYDOMAIN}.conf
